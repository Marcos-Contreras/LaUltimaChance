const plants = [
    ...
    {
      id: 3,
      name: 'Margarina Iberia 4 en 1 sin sal',
      price: 10.50,
      like: false,
      img: require('../assets/Iberia.png'),
      date: '20-05-2022',
      about:
    ...
    {
      id: 4,
      name: 'Leche UHT semidescremada Aguascalientes',
      price: 14.00,
      like: true,
      img: require('../assets/Leche.png'),
      date: '20-05-2022',
      about:
    ...
    {
      id: 5,
      name: 'Queso fresco ranchero Aguascalientes',
      price: 26.50,
      like: true,
      img: require('../assets/Queso.png'),
      date: '20-05-2022',
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
    {
      id: 6,
      name: 'Yoghurt Great Value Batido sabor bayas mixtas',
      price: 13.50,
      like: false,
      img: require('../assets/Yogurth.png'),
      date: '20-05-2022',
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
