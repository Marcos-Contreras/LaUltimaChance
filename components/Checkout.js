...
import { NativeBaseProvider, Text, Button, Box, Heading,  Radio, HStack, CheckIcon, Input, Divider, Image, Select, Checkbox, Link } from 'native-base';
    ...
    return (
      ...
      <Radio.Group
          ...
          <Radio size={"sm"} value="one2" my={1}>
            <Image mx="3" source={
      require( "../resources/tarjeta1.png")
    }  width={20}  
       height={5}
    />
            </Radio>
